namespace Chavo.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            {
                var functionary = db.Functionaries.Where(f => f.UserName == model.Email).FirstOrDefault();
                if (functionary==null)
                {
        ...
        [AllowAnonymous]
        public ActionResult Index(string userName, string control)
        {
            if (!UsersHelper.ExistUser(userName))
            {
                return RedirectToAction("Register", new { userName = userName, control = control });
            }
            else
            {
                return RedirectToAction("ForgotPassword", new { userName = userName, control = control });
            }
        }
        ...
        [AllowAnonymous]
        public ActionResult Register(string userName, string control)
        {
        ...
        [AllowAnonymous]
        public ActionResult ForgotPassword(string userName, string control)
        {
            using (var db = new DataContext())
            {
